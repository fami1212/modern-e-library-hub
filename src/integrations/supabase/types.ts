    ...
    Tables: {
      book_reviews: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_book_reviews_book"
            columns: ["book_id"]
            isOneToOne: false
            referencedRelation: "books"
            referencedColumns: ["id"]
      ...
      borrowings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_borrowings_user"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      favorites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_favorites_book"
            columns: ["book_id"]
            isOneToOne: false
            referencedRelation: "books"
            referencedColumns: ["id"]
      ...
      reading_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_reading_sessions_book"
            columns: ["book_id"]
            isOneToOne: false
            referencedRelation: "books"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_reading_sessions_user"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      user_roles: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_roles_user_profiles"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
